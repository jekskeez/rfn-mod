package dragonBones.objects
{
   ...
   public final class §_-d1n§
   {
      
      public function §_-d1n§()
      {
         super();
      }
      
      public static function §_-637§(param1:XML, param2:Number = 1) : Object
      {
         var _loc4_:XML = null;
      ...
      public static function §_-r2o§(param1:XML) : SkeletonData
      {
         var _loc5_:XML = null;
         if(!param1)
         {
      ...
      private static function parseBoneData(param1:XML) : BoneData
      {
         ...
         _loc2_.length = Number(param1[ConstValues.§_-11h§]);
         var _loc3_:String = param1[ConstValues.§_-Ec§];
         if(_loc3_)
         {
            _loc2_.scaleMode = parseInt(_loc3_);
         }
         var _loc4_:String = param1[ConstValues.§_-y1Y§][0];
         switch(_loc4_)
         {
            case "0":
            case "false":
         ...
         parseTransform(param1[ConstValues.§_-b1l§][0],_loc2_.global);
      ...
      private static function parseDisplayData(param1:XML, param2:SkeletonData) : DisplayData
      {
         ...
         parseTransform(param1[ConstValues.§_-b1l§][0],_loc3_.transform,_loc3_.pivot);
         return _loc3_;
      }
      ...
      private static function parseTransformFrame(param1:XML, param2:uint) : TransformFrame
      {
         ...
         parseTransform(param1[ConstValues.§_-b1l§][0],_loc3_.global,_loc3_.pivot);
