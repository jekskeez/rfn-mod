package dragonBones.utils
{
   public final class ConstValues
   {
      ...
      public static const §_-B1M§:String = "dragonBones";
      
      public static const ARMATURE:String = "armature";
      
      public static const §_-X1j§:String = "skin";
      
      public static const BONE:String = "bone";
      
      public static const §_-z2j§:String = "slot";
      
      public static const DISPLAY:String = "display";
      
      public static const ANIMATION:String = "animation";
      
      public static const §_-sI§:String = "timeline";
      
      public static const FRAME:String = "frame";
      
      public static const §_-b1l§:String = "transform";
      
      public static const COLOR_TRANSFORM:String = "colorTransform";
      
      public static const §_-D2j§:String = "TextureAtlas";
      
      public static const §_-K1F§:String = "SubTexture";
      
      public static const A_VERSION:String = "version";
      
      public static const §_-j2h§:String = "imagePath";
      ...
      public static const §_-11h§:String = "length";
      ...
      public static const §_-212§:String = "hide";
      ...
      public static const §_-y16§:String = "blendMode";
      
      public static const §_-l2H§:String = "width";
      
      public static const §_-X1u§:String = "height";
      
      public static const §_-Ec§:String = "scaleMode";
      
      public static const §_-y1Y§:String = "fixedRotation";
