package dragonBones.utils
{
   ...
   public final class DBDataUtil
   {
      ...
      public static function transformArmatureData(param1:ArmatureData) : void
      {
         ...
         var _loc2_:Vector.<BoneData> = param1.§_-f1i§;
         ...
         while(_loc3_--)
         {
            ...
            if(_loc4_.parent)
            {
               _loc5_ = param1.§_-2Z§(_loc4_.parent);
               if(_loc5_)
               {
                  _loc4_.transform.copy(_loc4_.global);
                  §_-G9§.§_-U2b§(_loc4_.transform,_loc5_.global);
               }
            }
         }
      }
      
      public static function §_-XR§(param1:ArmatureData) : void
      {
         var _loc2_:Vector.<AnimationData> = param1.§_-gi§;
         var _loc3_:* = int(_loc2_.length);
         while(_loc3_--)
         {
      ...
      public static function transformAnimationData(param1:AnimationData, param2:ArmatureData) : void
      {
         ...
         var _loc3_:SkinData = param2.§_-I1v§(null);
         var _loc4_:Vector.<BoneData> = param2.§_-f1i§;
         var _loc5_:Vector.<SlotData> = _loc3_.§_-53R§;
         var _loc6_:* = int(_loc4_.length);
         while(_loc6_--)
         {
            _loc7_ = _loc4_[_loc6_];
            _loc8_ = param1.§_-h2U§(_loc7_.name);
            if(_loc8_)
            {
               _loc9_ = null;
               ...
               _loc11_ = _loc7_.parent ? param1.§_-h2U§(_loc7_.parent) : null;
               ...
               while(_loc18_ < _loc16_)
               {
                  ...
                  if(_loc11_)
                  {
                     ...
                     §_-g2J§(_loc11_,_loc17_.position,_helpTransform2);
                     §_-G9§.§_-U2b§(_helpTransform1,_helpTransform2);
                  ...
                  if(!_loc13_)
                  {
                     _loc13_ = _loc8_.§_-R1B§;
                     _loc13_.copy(_loc17_.transform);
                     _loc13_.skewX = §_-G9§.§_-n1w§(_loc13_.skewX);
                     _loc13_.skewY = §_-G9§.§_-n1w§(_loc13_.skewY);
                     _loc14_ = _loc8_.§_-P1o§;
                     _loc14_.x = _loc17_.pivot.x;
                     _loc14_.y = _loc17_.pivot.y;
                  }
                  _loc17_.transform.x -= _loc13_.x;
                  _loc17_.transform.y -= _loc13_.y;
                  _loc17_.transform.skewX = §_-G9§.§_-n1w§(_loc17_.transform.skewX - _loc13_.skewX);
                  _loc17_.transform.skewY = §_-G9§.§_-n1w§(_loc17_.transform.skewY - _loc13_.skewY);
                  ...
                  if(_loc15_)
                  {
                     ...
                     {
                        _loc17_.transform.skewX = _loc15_.transform.skewX + §_-G9§.§_-n1w§(_loc17_.transform.skewX - _loc15_.transform.skewX);
                        _loc17_.transform.skewY = _loc15_.transform.skewY + §_-G9§.§_-n1w§(_loc17_.transform.skewY - _loc15_.transform.skewY);
                     }
                  }
                  _loc15_ = _loc17_;
                  _loc18_++;
      ...
      public static function §_-g2J§(param1:TransformTimeline, param2:Number, param3:DBTransform) : void
      {
         ...
         while(_loc5_--)
         {
            ...
            if(_loc6_.position <= param2 && _loc6_.position + _loc6_.duration > param2)
            {
               ...
               else
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = §_-b2t§.§_-81D§(_loc8_,_loc7_);
                  }
                  ...
                  param3.skewX = §_-G9§.§_-n1w§(_loc6_.global.skewX + (_loc9_.global.skewX - _loc6_.global.skewX) * _loc8_);
                  param3.skewY = §_-G9§.§_-n1w§(_loc6_.global.skewY + (_loc9_.global.skewY - _loc6_.global.skewY) * _loc8_);
      ...
      public static function addHideTimeline(param1:AnimationData, param2:ArmatureData) : void
      {
         ...
         var _loc3_:Vector.<BoneData> = param2.§_-f1i§;
         var _loc4_:* = int(_loc3_.length);
         while(_loc4_--)
         {
            _loc5_ = _loc3_[_loc4_];
            _loc6_ = _loc5_.name;
            if(!param1.§_-h2U§(_loc6_))
            {
               param1.addTimeline(TransformTimeline.§_-82j§,_loc6_);
            }
         }
      }
   }
