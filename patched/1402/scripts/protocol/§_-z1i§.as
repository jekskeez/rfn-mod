package protocol
{
   ...
   public class §_-z1i§ extends ByteArray
   {
      
      private static const §_-f1v§:uint = 65000;
      
      public function §_-z1i§()
      {
         super();
      }
      
      public static function §_-t17§(param1:uint) : Array
      {
         var _loc4_:uint = 0;
         var _loc2_:Array = [];
         var _loc3_:* = 0;
      ...
      public function §_-C1W§(param1:*) : int
      {
         var _loc2_:uint = 0;
         var _loc3_:uint = 0;
         var _loc4_:int = 0;
      ...
      public function §_-jk§() : *
      {
         ...
         return _loc3_ == 0 ? _loc2_ : §_-X2n§.§_-O2R§(_loc2_,_loc3_);
      }
      
      public function §_-d2z§(param1:String) : void
      {
         var _loc2_:String = this.§_-924§(param1);
         this.§_-C1W§(_loc2_.length);
         this.writeUTFBytes(_loc2_);
      }
      
      public function §_-o1§() : String
      {
         return this.readUTFBytes(this.§_-jk§());
      }
      
      public function §_-N4§(param1:uint = 0, param2:uint = 0) : String
      {
         var _loc8_:uint = 0;
      ...
      private function §_-924§(param1:String) : String
      {
         return unescape(encodeURIComponent(param1));
      }
      
      private function §_-W1g§(param1:String) : String
      {
