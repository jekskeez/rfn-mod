package §_-H1l§
{
   ...
   public class §_-f28§ extends b2Controller
   {
      ...
      override public function Step(param1:b2TimeStep) : void
      {
         ...
         while(_loc6_ != _loc2_)
         {
            if(_loc6_ != this.body)
            {
               ...
               if(!(_loc13_ is Hero && (!this.affectHero || (_loc13_ as Hero).behaviourController.getState(§_-f6§) != null)))
               {
                  if(!(!this.affectObjects && (!(_loc13_ is Hero) || !this.§_-3M§(_loc13_ as Hero) || _loc13_ is Sensor || _loc13_ is ClickButton)))
                  {
                     if(_loc6_.IsAwake())
                     {
                              ...
                              if(Math.sqrt(_loc11_) <= this.maxDistance)
                              {
                                 ...
                                 if(this.disableGlobalGravity)
                                 {
                                    ...
                                    if(_loc15_)
                                    {
                                       ...
                                       _loc17_ = this.§_-k1p§.GetNegative();
                                 ...
                                 if(this.addExtGrav && _loc7_.GetUserData() is Hero)
                                 {
                                    ...
                                    (_loc7_.GetUserData() as Hero).§_-X1b§(_loc18_);
                                 }
                              }
                           }
                        }
