package §_-ZL§
{
   ...
   public class §_-c20§ extends Dialog
   {
      ...
      private static var _instance:§_-c20§ = null;
      ...
      private function §_-CU§(param1:Object) : void
      {
      ...
      private function §_-63L§(param1:int, param2:int) : void
      {
         if(param2 != 0)
         {
            this.§_-F28§[param1]["label"] += gls("   Невидимых: {0}",param2);
