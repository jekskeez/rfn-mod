package §_-j2H§
{
   ...
   public class §_-41K§ extends §_-I1S§
   {
      ...
      private static const §_-ql§:b2FixtureDef = new b2FixtureDef(§_-G2l§,null,0.8,0,200,§_-I1S§.§_-53X§,§_-I1S§.§_-C3c§,0);
      
      public function §_-41K§()
      {
         super(WIDTH,§_-i2u§,Island3,§_-ql§,§_-G2l§);
      }
   }
}
