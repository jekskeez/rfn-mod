package flash
{
   ...
   public class §_-x1s§
   {
      ...
      public static var §_-n1s§:MovieClip;
      
      public function §_-x1s§()
      {
      }
      ...
      public static function §_-s1I§(param1:URLRequest, param2:String = undefined) : void
      {
      ...
      public static function §_-B2Y§(param1:*, param2:Class) : Object
      {
