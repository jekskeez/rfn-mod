package §_-o10§
{
   ...
   public class §_-s2O§ extends §_-S2w§
   {
      ...
      public function §_-s2O§(param1:Hero, param2:Array)
      {
         super(param1,param2);
         this.§_-T2a§ = §_-pl§.§_-O2y§;
      }
      ...
      private function §_-t1D§() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(!(!_loc2_ || _loc2_.isDead || _loc2_.inHollow || !_loc2_.shaman))
            {
               ...
               {
                  if((_loc2_.§_-ov§[_loc3_] is §_-s2O§ || _loc2_.§_-ov§[_loc3_] is §_-HO§) && _loc2_.§_-ov§[_loc3_] != this && _loc2_.§_-ov§[_loc3_].active)
                  {
