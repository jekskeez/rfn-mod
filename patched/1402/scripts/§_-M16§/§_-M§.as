package §_-M16§
{
   ...
   public class §_-M§ extends §_-aS§ implements §_-U1I§, §_-hQ§, §_-xn§, §_-3l§, §_-l2r§, §_-F1c§, §_-L1d§, §_-y1D§
   {
      ...
      private var ground0:§_-gy§ = null;
      
      private var ground1:§_-gy§ = null;
      ...
      private var rope0:§_-KS§ = new §_-KS§();
      
      private var rope1:§_-KS§ = new §_-KS§();
      
      private var rope2:§_-KS§ = new §_-KS§();
      
      private var §_-cJ§:b2PulleyJointDef = null;
      
      private var body0Id:int = -1;
      
      private var body1Id:int = -1;
      
      private var §_-92D§:Number = 1;
      
      private var §_-f2N§:Number = 0;
      
      private var joint:b2Joint = null;
      
      private var world:b2World = null;
      
      private var view:§_-aS§ = new §_-aS§(new PulleyJointView());
      ...
      public function §_-M§()
      {
         ...
         this.ground0 = new §_-32S§(this);
         this.ground1 = new §_-32S§(this);
         this.update();
      }
      ...
      override public function hitTestObject(param1:DisplayObject) : Boolean
      {
         ...
         return this.§_-hn§(this.anchor0.x,this.anchor0.y,this.ground0.x,this.ground0.y,_loc2_.x,_loc2_.y,_loc3_.x,_loc3_.y) || this.§_-hn§(this.anchor0.x,this.anchor0.y,this.ground0.x,this.ground0.y,_loc2_.x,_loc2_.y,_loc4_.x,_loc4_.y) || this.§_-hn§(this.anchor0.x,this.anchor0.y,this.ground0.x,this.ground0.y,_loc4_.x,_loc4_.y,_loc5_.x,_loc5_.y) || this.§_-hn§(this.anchor0.x,this.anchor0.y,this.ground0.x,this.ground0.y,_loc3_.x,_loc3_.y,_loc5_.x,_loc5_.y) || this.§_-hn§(this.ground0.x,this.ground0.y,this.ground1.x,this.ground1.y,_loc2_.x,_loc2_.y,_loc3_.x,_loc3_.y) || this.§_-hn§(this.ground0.x,this.ground0.y,this.ground1.x,this.ground1.y,_loc2_.x,_loc2_.y,_loc4_.x,_loc4_.y) || this.§_-hn§(this.ground0.x,this.ground0.y,this.ground1.x,this.ground1.y,_loc4_.x,_loc4_.y,_loc5_.x,_loc5_.y) || this.§_-hn§(this.ground0.x,this.ground0.y,this.ground1.x,this.ground1.y,_loc3_.x,_loc3_.y,_loc5_.x,_loc5_.y) || this.§_-hn§(this.ground1.x,this.ground1.y,this.anchor1.x,this.anchor1.y,_loc2_.x,_loc2_.y,_loc3_.x
         ,_loc3_.y) || this.§_-hn§(this.ground1.x,this.ground1.y,this.anchor1.x,this.anchor1.y,_loc2_.x,_loc2_.y,_loc4_.x,_loc4_.y) || this.§_-hn§(this.ground1.x,this.ground1.y,this.anchor1.x,this.anchor1.y,_loc4_.x,_loc4_.y,_loc5_.x,_loc5_.y) || this.§_-hn§(this.ground1.x,this.ground1.y,this.anchor1.x,this.anchor1.y,_loc3_.x,_loc3_.y,_loc5_.x,_loc5_.y);
      }
      ...
      public function §_-x26§(param1:GameMap) : void
      {
         ...
         _loc2_.Add(new b2Vec2(-27.55 / Game.§_-12A§,26.7 / Game.§_-12A§));
         this.anchor0.position = _loc2_;
         _loc2_.Add(new b2Vec2(27.55 * 2 / Game.§_-12A§,0));
         this.anchor1.position = _loc2_;
         _loc2_.Add(new b2Vec2(0,-26.7 * 2 / Game.§_-12A§));
      ...
      public function build(param1:b2World) : void
      {
         ...
         {
            this.§_-cJ§ = new b2PulleyJointDef();
            this.§_-cJ§.Initialize(_loc2_,_loc3_,this.ground0.position,this.ground1.position,this.anchor0.position,this.anchor1.position,this.ratio);
         }
         this.§_-cJ§.ratio = this.ratio;
         this.§_-cJ§.collideConnected = true;
         this.joint = param1.CreateJoint(this.§_-cJ§);
         this.§_-f2N§ = (this.joint as b2PulleyJoint).GetLength1() * Game.§_-12A§;
      ...
      public function §_-m1Y§() : *
      {
         ...
         if(this.§_-cJ§ != null)
         {
            _loc1_.push([this.body0 ? this.body0.id : -1,this.body1 ? this.body1.id : -1,[this.§_-cJ§.localAnchorA.x,this.§_-cJ§.localAnchorA.y],[this.§_-cJ§.localAnchorB.x,this.§_-cJ§.localAnchorB.y],[this.§_-cJ§.groundAnchorA.x,this.§_-cJ§.groundAnchorA.y],[this.§_-cJ§.groundAnchorB.x,this.§_-cJ§.groundAnchorB.y],this.§_-cJ§.lengthA,this.§_-cJ§.lengthB,this.§_-cJ§.maxLengthA,this.§_-cJ§.maxLengthB]);
         }
         return _loc1_;
      }
      ...
      public function §_-o2I§(param1:*) : void
      {
         ...
         this.§_-cJ§.groundAnchorA = new b2Vec2(param1[6][4][0],param1[6][4][1]);
         this.§_-cJ§.groundAnchorB = new b2Vec2(param1[6][5][0],param1[6][5][1]);
         this.§_-cJ§.lengthA = param1[6][6];
         this.§_-cJ§.lengthB = param1[6][7];
         this.§_-cJ§.maxLengthA = param1[6][8];
         this.§_-cJ§.maxLengthB = param1[6][9];
      }
      ...
      public function update(param1:Number = 0) : void
      {
         ...
         if(this.joint != null)
         {
            this.ground0.rotation = (this.§_-f2N§ - this.rope0.length) * 2;
            this.ground1.rotation = (this.§_-f2N§ - this.rope0.length) * 2;
         }
         ...
         this.rope1.offset = this.§_-f2N§ - this.rope0.length;
