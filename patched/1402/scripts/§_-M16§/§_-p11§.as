package §_-M16§
{
   ...
   public class §_-p11§ extends §_-aS§ implements §_-U1I§, §_-hQ§, §_-xn§, §_-3l§, §_-l2r§, §_-F1c§, §_-L1d§
   {
      ...
      private var spring:§_-KS§ = new §_-KS§();
