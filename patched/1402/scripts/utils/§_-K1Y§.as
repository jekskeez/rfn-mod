package utils
{
   ...
   public class §_-K1Y§
   {
      ...
      public function §_-K1Y§()
      {
         super();
      }
      
      public static function §_-P2W§(param1:TextField, param2:String, param3:Class, param4:Number, param5:Number, param6:int, param7:int, param8:Boolean, param9:Boolean = true) : Vector.<DisplayObject>
      {
      ...
      public static function §_-y2p§(param1:TextField, param2:String, param3:DisplayObject, param4:Number, param5:Number, param6:int, param7:int, param8:Boolean, param9:Boolean = true) : Vector.<DisplayObject>
      {
         var _loc12_:Rectangle = null;
         var _loc10_:int = -1;
         var _loc11_:Vector.<DisplayObject> = new Vector.<DisplayObject>();
      ...
      public static function §_-31q§(param1:TextField, param2:Array) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
