package utils
{
   ...
   public class §_-L2J§
   {
      ...
      private static const §_-A3o§:TextFormat = new TextFormat(§_-i5§.§_-c10§,12,0,false);
      ...
      public static function §_-CS§(param1:TextField, param2:String, param3:int, param4:Boolean = false, param5:Boolean = true, param6:int = 0) : void
      {
         do
         {
            if(!param4)
      ...
      public static function §_-61Q§(param1:CheckBox, param2:TextFormat = null) : void
      {
         if(param2 == null)
         {
            param2 = §_-A3o§;
