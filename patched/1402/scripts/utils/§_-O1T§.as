package utils
{
   ...
   public class §_-O1T§
   {
      ...
      public static function scale(param1:Bitmap, param2:Number, param3:Number) : Bitmap
      {
         ...
         §_-O1T§.resize(_loc4_,param2,param3);
         return _loc4_;
      }
      ...
      public static function load(param1:String, param2:Object, param3:Function, param4:* = null, param5:Boolean = false) : void
      {
         ...
         complete = (function(param1:Function, param2:*):Function
         {
            ...
            return function(param1:Event):void
            {
               ...
               {
                  §_-p2U§.add("Failed to load photo1",e);
         ...
         fail = (function(param1:Function, param2:*):Function
         {
            ...
            return function(param1:Event):void
            {
               §_-p2U§.add("Failed to load photo2",param1);
               onComplete(null,data);
            };
         })(onComplete,data);
         loader = new Loader();
         ...
         while(tries != 0)
         {
            ...
            {
               §_-p2U§.add("Failed to load photo3",e);
            }
            tries--;
         }
         onComplete(null,data);
      ...
      public static function §_-519§(param1:DisplayObject, param2:Number, param3:Number) : Object
      {
      ...
      public static function §_-oM§(param1:DisplayObject, param2:int, param3:int) : Bitmap
      {
      ...
      public static function §_-L2A§(param1:BitmapData) : BitmapData
      {
      ...
      {
         var _loc4_:Object = §_-519§(param1,param2,param3);
