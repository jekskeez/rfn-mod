package utils
{
   public class §_-B1d§
   {
      ...
      public static function §_-C2C§(param1:Number) : int
      {
         if(param1 == 0)
         {
            return 0;
      ...
      public static function §_-g2n§(param1:int) : String
      {
      ...
      public static function §_-z2d§(param1:int) : String
      {
         var _loc2_:String = "";
      ...
      public static function §_-j1x§(param1:int) : String
      {
         var _loc2_:String = "";
      ...
      public static function §_-wQ§(param1:int, param2:Boolean = false) : String
      {
      ...
      public static function §_-fn§(param1:int) : String
      {
         var _loc2_:Date = new Date(param1 * 1000);
         var _loc3_:String = §_-13m§(_loc2_.getDate());
         var _loc4_:String = §_-13m§(_loc2_.getMonth() + 1);
         var _loc5_:String = §_-13m§(_loc2_.getFullYear());
         return _loc3_ + "." + _loc4_ + "." + _loc5_;
      }
      
      private static function §_-13m§(param1:int) : String
      {
