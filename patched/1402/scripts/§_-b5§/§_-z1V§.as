package §_-b5§
{
   ...
   internal class §_-z1V§
   {
      ...
      private static const §_-U1a§:XML = <font>
      ...
      public static function get texture() : Texture
      {
         ...
         texture = Texture.§_-h2H§(bitmapData,false);
         bitmapData.dispose();
         bitmapData = null;
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§_-QU§,§_-Y2x§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = int(§_-A2j§.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§_-A2j§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§_-QU§,§_-Y2x§),_loc2_);
         _loc2_.clear();
         return _loc1_;
      }
