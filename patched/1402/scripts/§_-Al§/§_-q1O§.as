package §_-Al§
{
   ...
   public class §_-q1O§ extends §_-K1K§
   {
      
      private static const §_-D1q§:int = 5;
      
      private var §_-Y1§:§_-y1B§ = null;
      
      public function §_-q1O§()
      {
         super(§_-w1k§.§_-x2Q§);
      }
      ...
      override public function load(param1:*) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            this.§_-23Z§[_loc3_ * §_-D1q§].text = String(_loc4_);
            this.§_-23Z§[_loc3_ * §_-D1q§ + 1].text = this.§_-Jv§(_loc4_);
            this.§_-23Z§[_loc3_ * §_-D1q§ + 2].text = param1[_loc3_ * 4 + 1];
            this.§_-23Z§[_loc3_ * §_-D1q§ + 3].text = param1[_loc3_ * 4 + 2];
            this.§_-23Z§[_loc3_ * §_-D1q§ + 4].text = param1[_loc3_ * 4 + 3];
            _loc3_++;
         }
         this.§_-R2E§();
      }
      ...
      override public function save() : §_-z1i§
      {
         ...
         while(_loc2_ < this.§_-u1M§)
         {
            ...
            _loc5_ = this.§_-23Z§[_loc2_ * §_-D1q§ + 2].text;
            _loc6_ = this.§_-23Z§[_loc2_ * §_-D1q§ + 3].text;
            _loc7_ = this.§_-23Z§[_loc2_ * §_-D1q§ + 4].text;
            if(_loc4_ != "")
            {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            _loc3_.§_-C1W§(_loc1_[_loc2_][2]);
            _loc3_.§_-C1W§(_loc1_[_loc2_][3]);
            _loc2_++;
         }
         return _loc3_;
      }
      ...
      private function §_-Q2O§() : void
      {
         ...
         {
            this.§_-23Z§[_loc1_ * §_-D1q§ + 1].text = this.§_-Jv§(int(this.§_-23Z§[_loc1_ * §_-D1q§].text));
            _loc1_++;
         }
      }
      ...
      private function §_-V6§() : void
      {
         ...
         this.§_-Y1§ = new §_-y1B§("<body><a href=\'event:#\'>Добавить тотем</a></body>",0,0,§_-A3G§.style);
