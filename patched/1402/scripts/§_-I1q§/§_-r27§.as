package §_-I1q§
{
   ...
   public class §_-r27§ extends GameBody implements §_-71b§, §_-Pn§, §_-p2r§
   {
      ...
      public static const §_-SU§:Number = 3;
      
      public static const §_-Vr§:Number = 0.4;
      ...
      override public function build(param1:b2World) : void
      {
         ...
         this.§_-W1u§ = §_-w10§.instance.§_-d1y§(§_-w10§.§_-Qc§);
         ...
         for each(_loc1_ in this.§_-21H§.squirrels.players)
         {
            if(!(_loc1_.isDead || _loc1_.inHollow))
            {
               ...
               if(_loc2_.Length() <= 6)
               {
                  ...
                  {
                     _loc1_.behaviourController.§_-W10§(new §_-rK§(§_-SU§,§_-Vr§));
                  }
               }
            }
         }
