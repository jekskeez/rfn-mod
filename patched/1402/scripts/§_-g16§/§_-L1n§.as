package §_-g16§
{
   ...
   public class §_-L1n§ extends §_-PP§
   {
      
      public static const §_-qU§:int = 120;
      
      public static const §_-93w§:Number = 1.2;
      
      private static const §_-53X§:uint = 1;
      
      private static const §_-C3c§:uint = §_-q2c§.§_-wI§ | §_-q2c§.§_-Dx§ | §_-q2c§.§_-rT§;
      
      private static const §_-G2l§:b2CircleShape = new b2CircleShape(12 / Game.§_-12A§);
      
      private static const §_-ql§:b2FixtureDef = new b2FixtureDef(§_-G2l§,null,0.8,0.1,5,§_-53X§,§_-C3c§,0);
      ...
      private var controller:§_-f28§;
      
      public function §_-L1n§()
      {
         super();
         this.view = new §_-aS§(new GravityPoiseImage());
         this.view.x = -15;
         this.view.y = -15;
         §_-J2J§(this.view);
      }
      ...
      override public function beginContact(param1:b2Contact) : void
      {
         ...
         var _loc4_:int = 3 * (Boolean(_loc3_) && _loc3_.§_-a1n§ ? 2 : 1);
         if(_loc3_)
         {
