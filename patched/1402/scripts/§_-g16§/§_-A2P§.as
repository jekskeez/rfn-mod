package §_-g16§
{
   ...
   public class §_-A2P§ extends §_-PP§ implements §_-e2t§
   {
      
      public static const §_-qU§:int = 80;
      
      public static const §_-93w§:Number = 0.2;
      ...
      override public function beginContact(param1:b2Contact) : void
      {
         ...
         var _loc4_:int = Boolean(_loc3_) && _loc3_.§_-a1n§ ? 2 : 1;
         if(_loc3_)
         {
