package §_-g16§
{
   ...
   public class §_-CM§ extends §_-PP§
   {
      
      public static const §_-qU§:int = 150;
      ...
      private static const §_-ql§:b2FixtureDef = new b2FixtureDef(§_-G2l§,null,0.8,0.1,0.3,§_-53X§,§_-C3c§,0);
      ...
      {
         super();
         this.view = new §_-f1u§(new GhostPoiseImage());
         this.view.loop = true;
         this.view.x = -15;
         this.view.y = -15;
         §_-J2J§(this.view);
      ...
      override public function beginContact(param1:b2Contact) : void
      {
         ...
         var _loc4_:int = 4 * (Boolean(_loc3_) && _loc3_.§_-a1n§ ? 2 : 1);
         if(_loc3_)
         {
