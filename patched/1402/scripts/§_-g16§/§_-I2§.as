package §_-g16§
{
   ...
   public class §_-I2§ extends §_-XJ§
   {
      
      private static const §_-t5§:Number = 5;
      
      public static const §_-G1v§:int = 10;
      
      public function §_-I2§()
      {
         super();
      }
      ...
      {
         this.view = new §_-53v§(new SpikePoiseRespawnImage());
         this.view.x = -15;
         this.view.y = -15;
         §_-J2J§(this.view);
      }
      ...
      {
         var _loc2_:§_-v1N§ = param1.hero.§_-h1z§.§_-815§(§_-w3§,§_-v1N§.§_-W29§);
         var _loc3_:Boolean = _loc2_ != null && _loc2_.count >= §_-v1N§.§_-O2d§(§_-w3§);
         return !_loc3_;
      }
      
      override protected function §_-q1Y§(param1:DetectHeroEvent) : void
      {
         param1.hero.§_-h1z§.add(new §_-v1N§(§_-w3§,§_-v1N§.§_-W29§,§_-G1v§));
         if(this.§_-21H§.cast.castObject == null)
         {
            this.§_-21H§.cast.§_-ff§(new CastEvent(CastEvent.SELECT,§_-w3§));
         }
      }
      ...
      override protected function §_-E6§(param1:§_-V1t§) : void
      {
         ...
         Hero.self.§_-h1z§.add(new §_-v1N§(§_-w3§,§_-v1N§.§_-W29§,§_-G1v§));
         if(this.§_-21H§.cast.castObject == null)
         {
            this.§_-21H§.cast.§_-ff§(new CastEvent(CastEvent.SELECT,§_-w3§));
         }
      ...
      {
         Connection.§_-e2T§(§_-u1O§.§_-1q§,JSON.stringify({"GetPoise":[this.id,param1.hero.id]}));
      ...
      {
         Connection.§_-e2T§(§_-u1O§.§_-1q§,JSON.stringify({"RespawnPoise":[this.id]}));
      }
      
      override protected function §_-Gu§(param1:Object) : Array
      {
         if("GetPoise" in param1)
         {
            return param1["GetPoise"];
         }
         return null;
      }
      ...
      {
         if("RespawnPoise" in param1)
         {
            return param1["RespawnPoise"];
         }
         return null;
      }
