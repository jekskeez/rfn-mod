package §_-8Q§
{
   ...
   public class §_-nO§ extends GameBody implements §_-6D§, §_-NA§, §_-Pn§
   {
      ...
      private static const §_-UT§:int = 20;
      ...
      {
         super();
         this.view = new §_-f1u§(new StickyImg());
         this.view.loop = true;
         this.view.stop();
         this.view.y = 10;
         §_-J2J§(this.view);
         ...
         §_-J2J§(this.radius);
         this.fixed = true;
         this.§_-Y1N§ = new §_-Z2I§(new §_-aS§(new StickyIcon()));
      ...
      public function beginContact(param1:b2Contact) : void
      {
         ...
         if(!_loc2_ || _loc2_.isDead || _loc2_.inHollow || _loc2_.hasJoints("sticky") || this.hero == _loc2_ || this.§_-C2H§ == _loc2_)
         {
            return;
         }
      ...
      public function magnetize(param1:§_-62j§) : void
      {
         ...
         this.view.stop();
         if(Boolean(param1) && Boolean(param1.parentStarling) && Boolean(this.§_-Y1N§))
         {
      ...
      private function pinSquirrel(param1:int) : void
      {
         ...
         this.view.stop();
         this.view.visible = false;
         this.§_-Y1N§.show(§_-Z2I§.§_-A3A§,this.hero,5,new Point(this.position.x * Game.§_-12A§,this.position.y * Game.§_-12A§),new Point(0,Hero.§_-a1A§),this.§_-S1y§);
         this.§_-X11§ = this.hero.runSpeed * §_-UT§ / 100;
