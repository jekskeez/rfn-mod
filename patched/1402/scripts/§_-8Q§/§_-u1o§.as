package §_-8Q§
{
   ...
   public class §_-u1o§ extends GameBody implements §_-e2t§, §_-Pn§, §_-w1u§
   {
      
      private static const §_-53X§:uint = 1;
      
      private static const §_-P1l§:uint = 5;
      ...
      public function §_-u1o§()
      {
         super();
         this.view = new §_-aS§(new GlassBalkSmall());
         this.view.x = -50;
         this.view.y = -5;
         §_-J2J§(this.view);
      ...
      private function §_-EL§(param1:b2Vec2, param2:b2Vec2, param3:Number) : void
      {
         ...
         var _loc4_:§_-aS§ = §_-01M§.§_-q1k§(new GlassBalkPieces(),true);
         §_-J2J§(_loc4_);
