package §_-4I§
{
   ...
   public class §_-E5§ extends §_-dr§
   {
      
      public static const API:Number = 1;
      
      public function §_-E5§()
      {
         super();
      ...
      override public function onInitTween(param1:Object, param2:*, param3:§_-C2E§) : Boolean
      {
         ...
         §_-72C§ = Boolean(param3.vars.alpha != undefined && param2.alphaMultiplier == undefined);
         init(_loc4_,_loc5_);
         return true;
      }
   }
