package buttons
{
   ...
   public class §_-G15§ extends Sprite
   {
      
      private var button:SimpleButton;
      
      public var textField:§_-i5§ = null;
      
      public function §_-G15§(param1:SimpleButton, param2:TextFormat, param3:int = 0, param4:int = 0, param5:int = 0)
      {
         super();
         this.button = param1;
         addChild(this.button);
         param2.align = TextFormatAlign.CENTER;
         this.textField = new §_-i5§("",param3,param4,param2,param5);
