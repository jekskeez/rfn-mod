package §_-TK§
{
   ...
   public interface §_-51g§
   {
      
      function §_-31u§(param1:Point, param2:Boolean = false) : *;
      ...
      function §_-D2f§(param1:*, param2:int) : void;
      
      function §_-J2J§(param1:*) : *;
      
      function removeChildStarling(param1:*, param2:Boolean = true) : void;
      
      function §_-U2E§(param1:*) : Boolean;
      ...
      function §_-kD§(param1:int) : *;
      
      function §_-av§(param1:int, param2:Boolean = true) : DisplayObject;
