package
{
   ...
   public class §_-u1x§
   {
      ...
      private static const §_-rZ§:Array = [{
         "level":7,
         "exp":30
      },{
         "level":13,
      ...
      private static var §_-x1m§:Array = null;
      
      public var type:int = -1;
      
      public var §_-w2Z§:int = -1;
      ...
      public function §_-u1x§(param1:int, param2:int, param3:int, param4:int, param5:int)
      {
         super();
         this.type = param1;
         this.§_-w2Z§ = param5;
      ...
      public static function §_-F2J§(param1:int) : int
      {
         if(!locations)
         {
            locations = [§_-at§.§_-I6§,§_-at§.§_-D18§,§_-at§.§_-92b§,§_-at§.§_-U1s§,§_-at§.§_-j1i§];
         }
      ...
      {
         return this.value >= this.§_-Ht§;
      }
      
      public function get §_-Ht§() : int
      {
         return DATA[this.type]["value"][this.§_-w2Z§][this.§_-Vf§];
      }
      ...
      {
         return DATA[this.type]["text"].replace("#loc","<b>" + §_-at§.§_-13l§(this.location).name + "</b>");
      }
      ...
      public function get icon() : Sprite
      {
         if(!§_-x1m§)
         {
            §_-x1m§ = [QuestIcon0,QuestIcon1,QuestIcon2,QuestIcon3,QuestIcon4,QuestIcon5,QuestIcon6,QuestIcon7,QuestIcon8,QuestIcon9,QuestIcon10,QuestIcon11,QuestIcon12,QuestIcon13];
         }
         return new §_-x1m§[this.type]();
      }
      
      public function get award() : String
      {
         var _loc1_:String = this.§_-w2Z§ == 0 ? "#Ac 50   #Mn 30   #Ex " : "#Ac 80   #Mn 40   #Ex ";
         var _loc2_:int = 0;
         while(_loc2_ < §_-rZ§.length)
         {
            if(§_-rZ§[_loc2_]["level"] >= §_-LZ§.§_-mA§)
            {
               _loc1_ += §_-rZ§[_loc2_]["exp"] * (this.§_-w2Z§ == 0 ? 1 : 2);
               break;
            }
            _loc2_++;
         }
      ...
      public function get §_-JX§() : String
      {
         return §_-B1d§.§_-g2n§(this.time - getTimer() / 1000);
      }
      
      private function get §_-Vf§() : int
      {
         return §_-F2J§(this.location);
      }
   }
}
