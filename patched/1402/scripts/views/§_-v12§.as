package views
{
   ...
   public class §_-v12§ extends Sprite
   {
      
      private static var §_-b2S§:Object = {};
      ...
      public function §_-v12§(param1:int, param2:Boolean = true, param3:Function = null)
      {
         super();
         this.id = param1;
      ...
      public function load() : void
      {
         ...
         if(this.id in §_-b2S§)
         {
            ...
            this.image.loadBytes(§_-b2S§[this.id],_loc2_);
            return;
         }
         ...
         this.§_-w1f§.load(new URLRequest(§_-Zy§.§_-Y13§ + "clothes/accessories/ImageAccessories" + this.id + ".png" + _loc1_));
      }
      ...
      private function onLoaded(param1:Event) : void
      {
         ...
         §_-b2S§[this.id] = (param1.currentTarget as URLLoader).data;
      }
      
      private function §_-03l§(param1:Event) : void
      {
         var _loc2_:int = 0;
