package views
{
   ...
   public class §_-Y2D§ extends Sprite
   {
      ...
      public function §_-Y2D§(param1:int, param2:Boolean = true, param3:Function = null)
      {
         super();
         this.id = param1;
      ...
      public function load() : void
      {
         ...
         this.loaded = true;
         var _loc1_:String = this.id in §_-P2x§.§_-h1w§ ? §_-P2x§.§_-h1w§[this.id] : "";
         ...
         this.§_-w1f§.load(new URLRequest(§_-Zy§.§_-Y13§ + "clothes/packages/ImagePackage" + this.id + ".png" + _loc1_));
      }
      ...
      {
         §_-p2U§.add("Failed to load PackageImage[Event]:" + param1.toString());
      }
   }
}
