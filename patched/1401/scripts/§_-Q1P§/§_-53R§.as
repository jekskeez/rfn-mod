package §_-Q1P§
{
   ...
   public class §_-53R§ extends Dialog
   {
      ...
      private static var _instance:§_-53R§ = null;
      ...
      private function §_-q§(param1:Object) : void
      {
      ...
      private function §_-f14§(param1:int, param2:int) : void
      {
         this.§_-k2z§[param1]["label"] += gls("   Лаги: {0}",param2);
         if(param2 >= §_-Kj§.§_-11l§)
         {
            this.§_-k2z§[param1]["marked"] = true;
         }
