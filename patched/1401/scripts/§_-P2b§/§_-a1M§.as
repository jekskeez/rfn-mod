package §_-P2b§
{
   ...
   public class §_-a1M§ extends §_-H2N§
   {
      ...
      public function §_-a1M§(param1:Hero)
      {
         super(param1);
         this.§_-it§ = §_-VU§;
      }
         ...
         switch(param1.type)
         {
            case §_-S2I§.§_-b1y§:
               ...
               while(_loc4_ < _loc3_.length)
               {
                  ...
                  if(!this.§_-qu§(_loc5_) || !this.§_-qu§(_loc6_))
                  {
                     --this.§_-I1y§;
                  }
                  else
                  {
                     this.§_-a2J§(_loc5_,_loc6_);
                  }
                  _loc4_++;
               }
               if(this.§_-I1y§ == 0)
      ...
      private function §_-J1h§() : void
      {
         ...
         if(_loc2_.length > 1)
         {
            _loc6_ = §_-Eg§.§_-j1G§(1,_loc2_.length - 1);
            _loc7_ = 0;
         ...
         if(_loc3_.length > 0)
         {
            Connection.§_-Li§(§_-h2B§.§_-b1y§,JSON.stringify({"hatter":[this.hero.id,_loc3_]}));
         }
         else
         {
            Connection.§_-Li§(§_-h2B§.§_-b1y§,JSON.stringify({"hatterFail":true}));
         }
      }
      ...
      private function §_-a2J§(param1:Hero, param2:Hero) : void
      {
         TweenMax.to(param1,1,{
            "x":param2.position.x * Game.§_-x2P§,
            "y":param2.position.y * Game.§_-x2P§,
      ...
      private function §_-V2f§(param1:Hero, param2:Hero) : void
      {
         ...
         var _loc4_:Hero = null;
         --this.§_-I1y§;
         if(this.§_-qu§(param1) && this.§_-qu§(param2))
         {
            this.§_-ZI§[param1.id] = param2.position.Copy();
         }
         if(this.§_-I1y§ != 0)
         {
            return;
         ...
         {
            for(_loc3_ in this.§_-ZI§)
            {
               _loc4_ = this.hero.game.squirrels.get(int(_loc3_));
               if(this.§_-qu§(_loc4_))
               {
                  _loc4_.position = this.§_-ZI§[_loc3_];
               }
            }
         }
         this.active = false;
