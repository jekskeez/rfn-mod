package §_-P2b§
{
   ...
   public class §_-71e§ extends §_-H2N§
   {
      
      protected var §_-S1u§:§_-h2I§ = null;
      
      protected var §_-z2f§:int = 0;
      ...
      public function §_-71e§(param1:Hero)
      {
         super(param1);
      }
      ...
      protected function §_-D2T§() : void
      {
         ...
         this.§_-91N§(this.§_-Us§);
      }
      
      protected function §_-91N§(param1:Point) : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(this.§_-qu§(_loc5_))
            {
               ...
               _loc6_.Subtract(new b2Vec2(this.§_-Us§.x / Game.§_-x2P§,this.§_-Us§.y / Game.§_-x2P§));
               if(Boolean(_loc5_.heroView.§_-iu§(this.§_-Us§)) || _loc6_.Length() < 6)
               {
                  _loc4_.push(_loc5_);
               }
            }
         ...
         if(_loc4_.length != 0)
         {
            this.§_-z2f§ = (§_-X2Z§.§_-C16§(_loc4_) as Hero).id;
