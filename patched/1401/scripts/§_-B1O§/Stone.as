package §_-B1O§
{
   ...
   public class Stone extends GameBody implements §_-R2m§, §_-21e§, §_-YY§
   {
      ...
      private static const §_-61b§:uint = 10 / Game.§_-x2P§;
      
      private static const §_-a19§:uint = 300 / Game.§_-x2P§;
      
      private static const §_-T2h§:Number = 45 / Game.§_-x2P§;
      
      private static const §_-u2I§:Array = [[0,0]];
      
      private var §_-s1Y§:b2Vec2 = new b2Vec2(§_-T2h§,§_-T2h§);
      
      private var view:§_-h2I§ = new §_-h2I§(new StoneView());
      ...
      {
         param1.x = param1.y = Math.max(Math.min(Math.max(param1.x,param1.y),§_-a19§),§_-61b§);
         this.§_-s1Y§ = param1;
