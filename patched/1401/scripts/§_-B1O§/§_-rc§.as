package §_-B1O§
{
   ...
   public class §_-rc§ extends §_-SU§
   {
      ...
      private static const §_-03A§:b2FixtureDef = new b2FixtureDef(§_-L1E§,null,0.8,0,200,§_-SU§.§_-52X§,§_-SU§.§_-FN§,0);
      
      public function §_-rc§()
      {
         super(WIDTH,§_-kI§,Island3,§_-03A§,§_-L1E§);
      }
   }
}
