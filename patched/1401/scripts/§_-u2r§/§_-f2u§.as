package §_-u2r§
{
   ...
   public class §_-f2u§ extends GameBody implements §_-Q2k§, §_-22J§, §_-p19§
   {
      ...
      public static const §_-O1a§:int = 75;
      ...
      override public function build(param1:b2World) : void
      {
         ...
         this.§_-A38§ = §_-93d§.instance.§_-23j§(§_-93d§.§_-d2P§);
      ...
      private function §_-Q2q§() : void
      {
         ...
         for each(_loc1_ in this.§_-H2D§.squirrels.players)
         {
            if(!(_loc1_.isDead || _loc1_.inHollow))
            {
               ...
               if(_loc2_.Length() <= 6)
               {
                  _loc3_ = new b2Vec2(§_-O1a§ * (_loc2_.x / _loc2_.Length()),§_-O1a§ * (_loc2_.y / _loc2_.Length()));
                  _loc1_.body.SetLinearVelocity(_loc3_);
                  if(_loc1_.id != this.playerId)
                  {
                     _loc1_.behaviourController.§_-gz§(new §_-R§(0.5));
                  }
               }
            }
         }
