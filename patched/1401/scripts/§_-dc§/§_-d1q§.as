package §_-dc§
{
   ...
   public class §_-d1q§
   {
      ...
      public static const §_-f1m§:int = 0;
      
      public static const §_-f13§:int = 1;
      
      public static const §_-01b§:int = 2;
      
      public static const §_-q1M§:int = 3;
      
      public static const §_-B3v§:int = 4;
      
      public static const §_-41R§:int = 5;
      
      public static const NONE:int = 255;
      
      public static const §_-120§:int = 3;
      
      public static const §_-F2G§:int = 10;
      ...
      public static const §_-Oc§:Array = [{
         "id":0,
         "level":1
      },{
         "id":1,
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < §_-d1q§.DATA.length)
         {
            if(§_-d1q§.DATA[_loc2_]["id"] == param1)
            {
               return §_-d1q§.DATA[_loc2_];
            }
            _loc2_++;
         }
         return null;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < §_-d1q§.§_-Oc§.length)
         {
            if(§_-d1q§.§_-Oc§[_loc2_]["id"] == param1)
            {
               return §_-d1q§.§_-Oc§[_loc2_];
            }
            _loc2_++;
         }
         return null;
      ...
      public static function §_-81e§(param1:int) : DisplayObject
      {
         if(param1 == NONE)
         {
            return null;
      ...
      public static function §_-hw§(param1:int) : DisplayObject
      {
         if(param1 == NONE)
         {
            return null;
      ...
      public static function §_-l7§(param1:int, param2:int = 0) : String
      {
         if(param1 == NONE)
         {
            return null;
      ...
      public static function §_-Oq§(param1:int) : String
      {
         if(param1 == NONE)
         {
            return null;
      ...
      public static function §_-A1x§(param1:int, param2:int = 0) : int
      {
         if(param1 == §_-d1q§.NONE)
         {
            return 0;
         }
         var _loc3_:Object = get(param1);
      ...
      public static function §_-B1H§(param1:int, param2:int = 0) : int
      {
         if(param1 == NONE)
         {
            return 0;
      ...
      public static function §_-c2§() : int
      {
         return DATA.length;
      }
      
      public static function §_-317§(param1:int) : int
      {
         if(param1 == NONE)
         {
            return 0;
      ...
      public static function §_-63t§(param1:int, param2:int) : Boolean
      {
         if(param1 == NONE || param1 >= §_-120§)
         {
            return false;
         }
