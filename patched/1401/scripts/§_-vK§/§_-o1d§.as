package §_-vK§
{
   ...
   public class §_-o1d§ extends §_-21O§
   {
      ...
      public function §_-o1d§(param1:Hero, param2:Array)
      {
         super(param1,param2);
         this.§_-i2D§ = §_-QC§.§_-r1s§;
      }
      ...
      private function §_-Fv§() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            if(!(!_loc2_ || _loc2_.isDead || _loc2_.inHollow || !_loc2_.shaman))
            {
               ...
               {
                  if((_loc2_.§_-515§[_loc3_] is §_-o1d§ || _loc2_.§_-515§[_loc3_] is §_-D1V§) && _loc2_.§_-515§[_loc3_] != this && _loc2_.§_-515§[_loc3_].active)
                  {
      ...
      {
         return Boolean(param1) && !param1.inHollow && !param1.isHare;
      }
   }
}
