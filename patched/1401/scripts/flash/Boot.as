package flash
{
   ...
   public dynamic class Boot extends MovieClip
   {
      ...
      public static var §_-tp§:Error;
      
      public static var §_-s2I§:Boolean = false;
      ...
      public static function §_-I3§(param1:Object) : String
      {
         var _loc5_:* = null;
      ...
      public static function §_-P1M§(param1:*, param2:*) : Boolean
      {
         var _loc4_:* = null;
         try
         {
      ...
      {
         var _loc2_:TextField = Boot.§_-Sf§();
         _loc2_.textColor = param1;
         _loc2_.filters = [];
      }
      
      public static function §_-Sf§() : TextField
      {
         var _loc2_:* = 0;
         var _loc3_:int = 0;
         var _loc4_:* = null as TextFormat;
         var _loc1_:MovieClip = §_-jX§.§_-y1l§;
         if(Boot.tf == null)
         {
      ...
      public static function §_-J1J§(param1:*, param2:Object) : void
      {
         var _loc3_:TextField = Boot.§_-Sf§();
         var _loc4_:String = param2 == null ? "(null)" : param2.fileName + ":" + int(param2.lineNumber);
         if(Boot.§_-fT§ == null)
         {
            Boot.§_-fT§ = [];
         }
         Boot.§_-fT§ = Boot.§_-fT§.concat((_loc4_ + ": " + Boot.__string_rec(param1,"")).split("\n"));
         _loc3_.text = Boot.§_-fT§.join("\n");
         var _loc5_:Stage = §_-jX§.§_-y1l§.stage;
         if(_loc5_ == null)
         {
            return;
         }
         while(int(Boot.§_-fT§.length) > 1 && _loc3_.height > _loc5_.stageHeight)
         {
            Boot.§_-fT§.shift();
            _loc3_.text = Boot.§_-fT§.join("\n");
         }
      ...
      public static function §_-x2O§(param1:String) : String
      {
         return param1;
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:MovieClip = §_-jX§.§_-y1l§;
         try
         {
         ...
         catch(_loc_e_:*)
         {
            ...
            {
               _loc2_.addEventListener(Event.ADDED_TO_STAGE,§_-K2d§);
            }
      ...
      public function §_-K2d§(param1:*) : void
      {
         §_-jX§.§_-y1l§.removeEventListener(Event.ADDED_TO_STAGE,§_-K2d§);
         start();
      }
   }
}
