package §_-Rn§
{
   ...
   public class §_-83t§ extends §_-h2I§ implements §_-I2G§, §_-72o§, §_-63Q§, §_-03u§, §_-C2x§, §_-Tm§, §_-A2f§
   {
      ...
      private var §_-f1B§:b2WeldJointDef = null;
      
      private var body0Id:int = -1;
      
      private var body1Id:int = -1;
      
      private var §_-42D§:b2Vec2;
      
      private var §_-p2Y§:b2Vec2;
      
      private var world:b2World = null;
      
      private var view:§_-h2I§ = new §_-h2I§(new WeldJointView());
      
      private var §_-Se§:§_-K2m§ = new §_-K2m§();
      
      public function §_-83t§()
      {
         super();
         §_-83v§(this.view);
         this.anchor0 = new §_-dv§(this,new §_-h2I§(new SteelPoint()));
         this.anchor1 = new §_-dv§(this,new §_-h2I§(new SteelPoint()));
      }
      
      override public function §_-g1s§(param1:*) : Boolean
      {
      ...
      public function build(param1:b2World) : void
      {
         ...
         {
            this.§_-f1B§ = new b2WeldJointDef();
            this.§_-f1B§.Initialize(_loc2_,_loc3_,this.anchor0.position);
         }
         this.joint = this.world.CreateJoint(this.§_-f1B§);
         this.§_-42D§ = this.§_-f1B§.bodyA.GetLocalPoint(this.anchor0.position);
         this.§_-p2Y§ = this.§_-f1B§.bodyB.GetLocalPoint(this.anchor1.position);
         this.anchor0.§_-B3K§ = false;
         this.anchor1.§_-B3K§ = false;
      }
      ...
      public function §_-A1X§() : *
      {
         ...
         if(this.§_-f1B§ != null)
         {
            _loc1_.push([this.body0 ? this.body0.id : -1,this.body1 ? this.body1.id : -1,[this.§_-f1B§.localAnchorA.x,this.§_-f1B§.localAnchorA.y],[this.§_-f1B§.localAnchorB.x,this.§_-f1B§.localAnchorB.y],this.§_-f1B§.referenceAngle]);
         }
         return _loc1_;
      }
      ...
      public function §_-41M§(param1:*) : void
      {
         ...
         this.§_-f1B§.localAnchorA = new b2Vec2(param1[3][2][0],param1[3][2][1]);
      ...
      public function update(param1:Number = 0) : void
      {
         ...
         if(this.§_-f1B§ != null)
         {
            _loc5_ = this.§_-f1B§.bodyA.GetWorldPoint(this.§_-42D§);
            _loc6_ = this.§_-f1B§.bodyB.GetWorldPoint(this.§_-p2Y§);
            this.anchor0.position = _loc5_;
            this.anchor1.position = _loc6_;
         }
         var _loc2_:b2Vec2 = Boolean(this.joint) && Boolean(this.§_-f1B§) ? _loc5_.Copy() : this.anchor0.position;
         _loc2_.Multiply(Game.§_-x2P§);
         var _loc3_:b2Vec2 = Boolean(this.joint) && Boolean(this.§_-f1B§) ? _loc6_.Copy() : this.anchor1.position;
         ...
         this.§_-Se§.start = new Point(_loc2_.x,_loc2_.y);
         this.§_-Se§.end = new Point(_loc3_.x,_loc3_.y);
      }
