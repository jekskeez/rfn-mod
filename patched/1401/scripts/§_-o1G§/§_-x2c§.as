package §_-o1G§
{
   ...
   public class §_-x2c§ extends §_-x2w§
   {
      
      public static const API:Number = 1;
      
      public function §_-x2c§()
      {
         super();
      ...
      override public function onInitTween(param1:Object, param2:*, param3:§_-y2k§) : Boolean
      {
         ...
         §_-ft§ = Boolean(param3.vars.alpha != undefined && param2.alphaMultiplier == undefined);
         init(_loc4_,_loc5_);
         return true;
      }
   }
