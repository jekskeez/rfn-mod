package §_-d11§
{
   ...
   public class §_-k1J§ extends §_-72C§
   {
      
      private static const §_-S12§:Number = 5;
      
      public static const §_-535§:int = 10;
      ...
      {
         this.view = new §_-s2v§(new SpikePoiseRespawnImage());
         this.view.x = -15;
         this.view.y = -15;
         §_-83v§(this.view);
      }
      ...
      {
         var _loc2_:§_-bM§ = param1.hero.§_-l2U§.§_-43X§(§_-4P§,§_-bM§.§_-t2G§);
         var _loc3_:Boolean = _loc2_ != null && _loc2_.count >= §_-bM§.§_-a2a§(§_-4P§);
         return !_loc3_;
      }
      
      override protected function §_-O1L§(param1:DetectHeroEvent) : void
      {
         param1.hero.§_-l2U§.add(new §_-bM§(§_-4P§,§_-bM§.§_-t2G§,§_-535§));
         if(this.§_-H2D§.cast.castObject == null)
         {
            this.§_-H2D§.cast.§_-52I§(new CastEvent(CastEvent.SELECT,§_-4P§));
         }
      }
      ...
      override protected function §_-91c§(param1:§_-i1L§) : void
      {
         ...
         Hero.self.§_-l2U§.add(new §_-bM§(§_-4P§,§_-bM§.§_-t2G§,§_-535§));
         if(this.§_-H2D§.cast.castObject == null)
         {
            this.§_-H2D§.cast.§_-52I§(new CastEvent(CastEvent.SELECT,§_-4P§));
         }
      ...
      {
         Connection.§_-Li§(§_-h2B§.§_-b1y§,JSON.stringify({"GetPoise":[this.id,param1.hero.id]}));
      ...
      {
         Connection.§_-Li§(§_-h2B§.§_-b1y§,JSON.stringify({"RespawnPoise":[this.id]}));
      }
