package §_-d11§
{
   ...
   public class §_-X5§ extends §_-72C§
   {
      ...
      {
         this.view = new §_-s2v§(new GhostPoiseRespawnImage() as MovieClip);
         this.view.x = -16;
         this.view.y = -16;
      ...
      {
         var _loc2_:§_-bM§ = param1.hero.§_-l2U§.§_-43X§(§_-p1i§,§_-bM§.§_-t2G§);
         var _loc3_:Boolean = _loc2_ != null && _loc2_.count >= §_-bM§.§_-a2a§(§_-p1i§);
         return !_loc3_;
      }
      
      override protected function §_-O1L§(param1:DetectHeroEvent) : void
      {
         param1.hero.§_-l2U§.add(new §_-bM§(§_-p1i§,§_-bM§.§_-t2G§,§_-535§));
         if(this.§_-H2D§.cast.castObject == null)
         {
            this.§_-H2D§.cast.§_-52I§(new CastEvent(CastEvent.SELECT,§_-p1i§));
         }
      }
      ...
      override protected function §_-91c§(param1:§_-i1L§) : void
      {
         ...
         Hero.self.§_-l2U§.add(new §_-bM§(§_-p1i§,§_-bM§.§_-t2G§,§_-535§));
         if(this.§_-H2D§.cast.castObject == null)
         {
            this.§_-H2D§.cast.§_-52I§(new CastEvent(CastEvent.SELECT,§_-p1i§));
         }
      ...
      {
         Connection.§_-Li§(§_-h2B§.§_-b1y§,JSON.stringify({"GetGhostPoise":[this.id,param1.hero.id]}));
      ...
      {
         Connection.§_-Li§(§_-h2B§.§_-b1y§,JSON.stringify({"RespawnGhostPoise":[this.id]}));
      }
