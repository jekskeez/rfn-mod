package §_-d11§
{
   ...
   public class §_-p1i§ extends §_-33Z§
   {
      
      public static const §_-m2H§:int = 150;
      ...
      private static const §_-03A§:b2FixtureDef = new b2FixtureDef(§_-L1E§,null,0.8,0.1,0.3,§_-52X§,§_-FN§,0);
      ...
      public function §_-p1i§()
      {
         super();
         this.view = new §_-d2d§(new GhostPoiseImage());
         this.view.loop = true;
         this.view.x = -15;
         this.view.y = -15;
         §_-83v§(this.view);
      ...
      override public function beginContact(param1:b2Contact) : void
      {
         ...
         var _loc4_:int = 4 * (Boolean(_loc3_) && _loc3_.§_-R1o§ ? 2 : 1);
         if(_loc3_)
         {
