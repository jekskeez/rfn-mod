package
{
   ...
   public class §_-iC§
   {
      ...
      public function §_-iC§(param1:Number, param2:Number, param3:Number)
      {
         super();
      ...
      public static function §_-g2c§(param1:b2Vec2, param2:b2Vec2) : Number
      {
      ...
      public static function §_-t27§(param1:b2Vec2, param2:b2Vec2) : §_-iC§
      {
         return new §_-iC§(param2.y - param1.y,param1.x - param2.x,-(param1.y * param2.x - param1.x * param2.y));
      }
      
      public function §_-41d§(param1:b2Vec2) : Boolean
      {
      ...
      public function get §_-f2g§() : Number
      {
