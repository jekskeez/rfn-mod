package utils
{
   ...
   public class §_-M4§ extends Sprite
   {
      
      public function §_-M4§(param1:String)
      {
         super();
         var _loc2_:TextFormat = new TextFormat(§_-22V§.§_-F2z§,11,0,true);
         var _loc3_:§_-22V§ = new §_-22V§(param1,0,0,_loc2_);
         addChild(_loc3_);
