package utils
{
   ...
   public class §_-A3M§ extends Bitmap
   {
      
      private static var point:Point = null;
      
      public var §_-B2v§:Array = null;
      ...
      public function §_-A3M§(param1:MovieClip, param2:Boolean = true, param3:Boolean = true, param4:Number = 0, param5:Rectangle = null)
      {
         super();
         if(param1 == null)
         {
         ...
         {
            this.currentFrame = 1;
            bitmapData = this.§_-yB§(param1,param4,param2,param3,param5)[0];
         }
         else
         {
            this.§_-B2v§ = this.§_-yB§(param1,param4,param2,param3,param5);
         }
         this.gotoAndStop(1);
      }
      
      public static function replace(param1:MovieClip, param2:Boolean = false, param3:Boolean = true, param4:Number = 0) : §_-A3M§
      {
         ...
         param1.visible = true;
         var _loc8_:§_-A3M§ = new §_-A3M§(param1,param2,param3,param4);
      ...
      {
         return this.§_-B2v§ ? int(this.§_-B2v§.length) : 1;
      }
      
      public function play() : void
      {
         if(!this.§_-B2v§ || this.isPlaying)
         {
            return;
         }
      ...
      {
         if(!this.§_-B2v§ || this.visible == false)
         {
            return;
         }
      ...
      {
         return this.§_-B2v§ ? (this.§_-B2v§[this.currentFrame - 1] as BitmapData).hitTest(new Point(),255,globalToLocal(param1)) : false;
      }
      ...
      private function §_-yB§(param1:MovieClip, param2:Number, param3:Boolean, param4:Boolean, param5:Rectangle = null) : Array
      {
         var _loc9_:int = 0;
      ...
      private function §_-52g§() : void
      {
         ...
         bitmapData = this.§_-B2v§[this.currentFrame - 1];
      }
   }
}
