package utils
{
   ...
   public class StringUtil
   {
      ...
      private static const §_-k10§:Array = [gls("первым"),gls("вторым"),gls("третьим"),gls("четвертым"),gls("пятым"),gls("шестым"),gls("седьмым"),gls("восьмым"),gls("девятым"),gls("десятым"),gls("одиннадцатым"),gls("двенадцатым"),gls("тринадцатым"),gls("четырнадцатым"),gls("пятнадцатым")];
      
      private static const §_-01V§:Object = {
      ...
      public static function §_-Q1p§(param1:int) : String
      {
         return §_-k10§[param1 - 1];
      }
      
      public static function stripHTML(param1:String) : String
      {
         param1 = XML(new XMLNode(XMLNodeType.TEXT_NODE,param1)).toXMLString();
         return StringUtil.§_-22O§(param1);
      }
      
      public static function §_-T2i§(param1:String) : String
      {
      ...
      public static function word(param1:String, param2:int) : String
      {
         ...
         var _loc3_:Array = §_-01V§[param1];
         if(param2 % 100 >= 10 && param2 % 100 <= 20 && §_-a9§.§_-sc§)
         {
            return _loc3_[0];
         }
         ...
         if(_loc4_ >= 2 && _loc4_ <= 4 && §_-a9§.§_-sc§)
         {
            return _loc3_[2];
         }
         return _loc3_[0];
      ...
      public static function §_-016§(param1:TextField, param2:int) : void
      {
      ...
      public static function §_-83Z§(param1:TextField, param2:int) : void
      {
      ...
      {
         return StringUtil.§_-g1P§(StringUtil.§_-21S§(param1));
      }
      ...
      public static function §_-92k§(param1:String) : String
      {
         ...
         {
            _loc5_[_loc6_] = §_-Rk§(_loc5_[_loc6_]);
            _loc6_++;
         }
         return _loc5_.join(" ");
      }
      
      public static function §_-61l§(param1:int, param2:Boolean = false) : String
      {
         var _loc3_:int = 0;
      ...
      public static function §_-uc§(param1:String, param2:int) : String
      {
      ...
      public static function §_-Ke§(param1:Array, param2:String = ", ") : String
      {
         var _loc3_:String = "";
         var _loc4_:int = 0;
         while(_loc4_ < param1.length)
      ...
      public static function §_-c1R§(param1:String) : §_-U1M§
      {
         param1 = unescape(encodeURIComponent(param1));
         var _loc2_:§_-U1M§ = §_-P1h§.get(param1.length);
         _loc2_.writeUTFBytes(param1);
         _loc2_.compress();
         return _loc2_;
      }
      
      public static function §_-B1K§(param1:§_-U1M§) : String
      {
         param1.uncompress();
         return param1.readUTFBytes(param1.length);
      }
      
      public static function §_-Bj§(param1:String) : Date
      {
      ...
      public static function §_-C1R§(param1:*) : int
      {
         if(param1 is Number)
         {
            return param1 & 0xFFFFFF;
         }
         var _loc2_:String = StringUtil.§_-22O§(param1);
         if(_loc2_.charAt(0) == "#")
         {
      ...
      private static function §_-Rk§(param1:String) : String
      {
         var ch:String = null;
