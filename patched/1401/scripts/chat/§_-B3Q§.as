package chat
{
   ...
   public class §_-B3Q§ extends §_-n1V§
   {
      ...
      public function §_-B3Q§(param1:Player, param2:Player, param3:int, param4:int, param5:int)
      {
         this.§_-L25§ = param1;
         this.§_-736§ = param2;
         this.§_-31l§ = param3;
      ...
      override public function get text() : String
      {
         ...
         {
            case §_-h2B§.§_-c26§:
               this.message = gls("Игроку {0} заблокирован чат{1}{2}",this.§_-L25§.name,this.§_-31l§ > 0 ? gls(" на {0}",§_-ex§.§_-M1D§(this.§_-31l§)) : "",!this.§_-736§ ? "" : gls(" модератором c ID{0}. Причина: {1}",this.§_-736§.id,§_-d1C§.§_-is§(this.§_-u2Q§)));
               break;
            case §_-h2B§.§_-YT§:
            case §_-h2B§.§_-03c§:
               this.message = gls("Игрок {0} заблокирован{1} модератором c ID{2}. Причина: {3}",this.§_-L25§.name,this.§_-31l§ > 0 ? gls(" на {0}",§_-ex§.§_-M1D§(this.§_-31l§)) : "",this.§_-736§.id,§_-d1C§.§_-is§(this.§_-u2Q§));
         }
