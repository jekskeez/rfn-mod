package dragonBones.objects
{
   ...
   public final class §_-x1l§
   {
      
      public function §_-x1l§()
      {
         super();
      }
      
      public static function §_-o1z§(param1:Object, param2:Number = 1) : Object
      {
      ...
      public static function §_-e1C§(param1:Object) : SkeletonData
      {
      ...
      private static function parseBoneData(param1:Object) : BoneData
      {
         ...
         _loc2_.length = Number(param1[ConstValues.§_-q2m§]) || 0;
         var _loc3_:Object = param1[ConstValues.§_-A2y§];
         if(_loc3_)
         {
            _loc5_ = _loc3_ as int;
            _loc2_.scaleMode = _loc5_;
         }
         var _loc4_:Boolean = param1[ConstValues.§_-y1h§] as Boolean;
         if(_loc4_)
         {
            _loc2_.fixedRotation = _loc4_;
         }
         parseTransform(param1[ConstValues.§_-a2i§],_loc2_.global);
      ...
      private static function parseDisplayData(param1:Object, param2:SkeletonData) : DisplayData
      {
         ...
         parseTransform(param1[ConstValues.§_-a2i§],_loc3_.transform,_loc3_.pivot);
         return _loc3_;
      }
      ...
      private static function parseTransformFrame(param1:Object, param2:uint) : TransformFrame
      {
         ...
         _loc3_.zOrder = Number(param1[ConstValues.A_Z_ORDER]);
         parseTransform(param1[ConstValues.§_-a2i§],_loc3_.global,_loc3_.pivot);
