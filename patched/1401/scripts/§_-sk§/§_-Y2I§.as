package §_-sk§
{
   ...
   internal class §_-Y2I§
   {
      ...
      private static const §_-c2K§:XML = <font>
      ...
      public static function get texture() : Texture
      {
         ...
         texture = Texture.§_-b2K§(bitmapData,false);
         bitmapData.dispose();
         bitmapData = null;
      ...
      {
         var _loc1_:BitmapData = new BitmapData(§_-C1A§,§_-h2x§);
         var _loc2_:ByteArray = new ByteArray();
         var _loc3_:int = int(§_-mL§.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            _loc2_.writeUnsignedInt(§_-mL§[_loc4_]);
            _loc4_++;
         }
         _loc2_.uncompress();
         _loc1_.setPixels(new Rectangle(0,0,§_-C1A§,§_-h2x§),_loc2_);
         _loc2_.clear();
         return _loc1_;
      }
