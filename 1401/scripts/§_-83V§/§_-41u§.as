package §_-83V§
{
   ...
   public class §_-41u§ extends GameBody implements §_-hx§, §_-s2K§, §_-22J§
   {
      ...
      private static const §_-LL§:int = 20;
      ...
      public function §_-41u§()
      {
         super();
         this.view = new §_-d2d§(new StickyImg());
         this.view.loop = true;
         this.view.stop();
         this.view.y = 10;
         §_-83v§(this.view);
         ...
         §_-83v§(this.radius);
         this.fixed = true;
         this.§_-N27§ = new §_-PY§(new §_-h2I§(new StickyIcon()));
      ...
      public function beginContact(param1:b2Contact) : void
      {
         ...
         if(!_loc2_ || _loc2_.isDead || _loc2_.inHollow || _loc2_.hasJoints("sticky") || this.hero == _loc2_ || this.§_-O1A§ == _loc2_)
         {
            return;
         }
         this.§_-oJ§(_loc2_.id);
      ...
      public function magnetize(param1:§_-g2l§) : void
      {
         ...
         this.view.stop();
         if(Boolean(param1) && Boolean(param1.parentStarling) && Boolean(this.§_-N27§))
         {
      ...
      private function pinSquirrel(param1:int) : void
      {
         ...
         if(!_loc2_ || _loc2_.isDead || _loc2_.inHollow || _loc2_.hasJoints("sticky"))
         {
            return;
         }
         if(this.hero)
         ...
         this.view.stop();
         this.view.visible = false;
         this.§_-N27§.show(§_-PY§.§_-I2i§,this.hero,5,new Point(this.position.x * Game.§_-x2P§,this.position.y * Game.§_-x2P§),new Point(0,Hero.§_-YH§),this.§_-Ep§);
         this.§_-h2K§ = this.hero.runSpeed * §_-LL§ / 100;
