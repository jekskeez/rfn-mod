package §_-83V§
{
   ...
   public class §_-827§ extends GameBody implements §_-21e§, §_-22J§, §_-YY§
   {
      
      private static const §_-52X§:uint = 1;
      
      private static const §_-Y1b§:uint = 10;
      ...
      public function §_-827§()
      {
         super();
         this.view = new §_-h2I§(new GlassBalkBig());
         this.view.x = -100;
         this.view.y = -5;
         §_-83v§(this.view);
      ...
      private function §_-Y2E§(param1:b2Vec2, param2:b2Vec2, param3:Number) : void
      {
         ...
         var _loc4_:§_-h2I§ = §_-a2§.§_-ZE§(new GlassBalkLongPieces(),true);
         §_-83v§(_loc4_);
