package §_-81N§
{
   ...
   public class §_-W1J§ extends b2Controller
   {
      
      public var §_-i2a§:Array = null;
      ...
      override public function Step(param1:b2TimeStep) : void
      {
         ...
         var _loc2_:Array = this.§_-i2a§.concat();
         var _loc3_:Hero = null;
         var _loc4_:* = int(_loc2_.length - 1);
         while(_loc4_ >= 0)
         {
            _loc3_ = _loc2_[_loc4_];
            if(_loc3_ && !_loc3_.isDead && !_loc3_.inHollow && _loc3_.up && _loc3_.§_-k2W§)
            {
